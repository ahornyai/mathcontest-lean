...
Oldjuk meg a következ˝o egyenletrendszert az egész számok halmazán
x^2-y^2-z^2=1
y+z-x=-3
-----
...
theorem arany2024_advanced_ii_i_ii {x y z : ℤ} : (x^2-y^2-z^2=1 ∧ y+z-x=-3) ↔ (x, y, z) ∈ SolutionSet := by
  unfold SolutionSet
